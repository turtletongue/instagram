import { CHANGE_COMMENT_INPUT, FETCH_POSTS_FAILURE, FETCH_POSTS_START, FETCH_POSTS_SUCCESS, SET_IS_LIKED, SET_IS_BOOKMARKED, ADD_COMMENT_START, ADD_COMMENT_SUCCESS, ADD_COMMENT_FAILURE, CLEAR_COMMENT_INPUT } from "./posts.constants";
...
export const fetchPosts = () => async (dispatch: any) => { 
  ...
  try {
    const data = [{
      id: '32323',
      author: { id: 'alternative.disney', avatar: 'https://scontent-frx5-1.cdninstagram.com/v/t51.2885-19/s320x320/37180174_2128883647392391_2180509584274227200_n.jpg?tp=1&_nc_ht=scontent-frx5-1.cdninstagram.com&_nc_ohc=p-XguE5bCK8AX9v4QS1&oh=80bd6ca7e744d819747cd5253d77a6fb&oe=606DB111' },
    ...
    dispatch(fetchPostsSuccess(data.map((post: any) => ({ ...post, commentInput: ''  }))));
  } catch (error) {
